...
void Vcpu_tb___024root__trace_chg_0_sub_0(Vcpu_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.__Vm_traceActivity[1U] 
        ...
        bufp->chgIData(oldp+35,(vlSelfRef.cpu_tb__DOT__dut__DOT__memory_stage__DOT__dm__DOT__ram
                                [(0x3fU & (vlSelfRef.cpu_tb__DOT__dut__DOT__alu_result_m_i 
                                           >> 2U))]),32);
    }
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[2U]))) {
        bufp->chgIData(oldp+36,(vlSelfRef.cpu_tb__DOT__dut__DOT__alu_result_w_i),32);
        bufp->chgIData(oldp+37,((vlSelfRef.cpu_tb__DOT__dut__DOT__pc_plus4_w_i 
                                 - (IData)(4U))),32);
        bufp->chgIData(oldp+38,(vlSelfRef.cpu_tb__DOT__dut__DOT__fetch_stage__DOT__pc),32);
        bufp->chgIData(oldp+39,(((IData)(4U) + vlSelfRef.cpu_tb__DOT__dut__DOT__fetch_stage__DOT__pc)),32);
        bufp->chgIData(oldp+40,(vlSelfRef.cpu_tb__DOT__dut__DOT__pc_d_i),32);
        bufp->chgIData(oldp+41,(vlSelfRef.cpu_tb__DOT__dut__DOT__pc_plus4_d_i),32);
        bufp->chgIData(oldp+42,(vlSelfRef.cpu_tb__DOT__dut__DOT__instr_d_i),32);
        bufp->chgIData(oldp+43,(((4U & (IData)(vlSelfRef.cpu_tb__DOT__dut__DOT__decode_stage__DOT__cu__DOT__controls))
                                  ...
                                  : ((2U & (IData)(vlSelfRef.cpu_tb__DOT__dut__DOT__decode_stage__DOT__cu__DOT__controls))
                                      ...
                                      : ((1U & (IData)(vlSelfRef.cpu_tb__DOT__dut__DOT__decode_stage__DOT__cu__DOT__controls))
                                          ...
                                          : (((- (IData)(
                                             ...
                                             | (vlSelfRef.cpu_tb__DOT__dut__DOT__instr_d_i 
                                                >> 0x14U)))))),32);
        bufp->chgCData(oldp+44,((0x1fU & (vlSelfRef.cpu_tb__DOT__dut__DOT__instr_d_i 
                                          >> 7U))),5);
        bufp->chgCData(oldp+45,(vlSelfRef.cpu_tb__DOT__dut__DOT__decode_stage__DOT__cu__DOT__alu_controls),4);
        bufp->chgCData(oldp+46,((3U & ((IData)(vlSelfRef.cpu_tb__DOT__dut__DOT__decode_stage__DOT__cu__DOT__controls) 
                                       >> 8U))),2);
        ...
        bufp->chgBit(oldp+51,((1U & ((IData)(vlSelfRef.cpu_tb__DOT__dut__DOT__decode_stage__DOT__cu__DOT__controls) 
                                     >> 4U))));
        bufp->chgBit(oldp+52,((1U & ((IData)(vlSelfRef.cpu_tb__DOT__dut__DOT__decode_stage__DOT__cu__DOT__controls) 
                                     >> 3U))));
        bufp->chgCData(oldp+53,((7U & (vlSelfRef.cpu_tb__DOT__dut__DOT__instr_d_i 
                                       >> 0xcU))),3);
        bufp->chgCData(oldp+54,((0x1fU & (vlSelfRef.cpu_tb__DOT__dut__DOT__instr_d_i 
                                          >> 0xfU))),5);
        bufp->chgCData(oldp+55,((0x1fU & (vlSelfRef.cpu_tb__DOT__dut__DOT__instr_d_i 
                                          >> 0x14U))),5);
        bufp->chgIData(oldp+56,(vlSelfRef.cpu_tb__DOT__dut__DOT__rd1_e_i),32);
        bufp->chgIData(oldp+57,(vlSelfRef.cpu_tb__DOT__dut__DOT__rd2_e_i),32);
        bufp->chgIData(oldp+58,(vlSelfRef.cpu_tb__DOT__dut__DOT__imm_val_e_i),32);
        bufp->chgIData(oldp+59,(vlSelfRef.cpu_tb__DOT__dut__DOT__pc_e_i),32);
        bufp->chgIData(oldp+60,(vlSelfRef.cpu_tb__DOT__dut__DOT__pc_plus4_e_i),32);
        bufp->chgCData(oldp+61,(vlSelfRef.cpu_tb__DOT__dut__DOT__rd_e_i),5);
        bufp->chgCData(oldp+62,(vlSelfRef.cpu_tb__DOT__dut__DOT__alu_control_e_i),4);
        bufp->chgCData(oldp+63,(vlSelfRef.cpu_tb__DOT__dut__DOT__res_src_e_i),2);
        bufp->chgBit(oldp+64,(vlSelfRef.cpu_tb__DOT__dut__DOT__mem_write_e_i));
        bufp->chgBit(oldp+65,(vlSelfRef.cpu_tb__DOT__dut__DOT__reg_write_e_i));
        bufp->chgBit(oldp+66,(vlSelfRef.cpu_tb__DOT__dut__DOT__jump_e_i));
        bufp->chgBit(oldp+67,(vlSelfRef.cpu_tb__DOT__dut__DOT__branch_e_i));
        bufp->chgBit(oldp+68,(vlSelfRef.cpu_tb__DOT__dut__DOT__alu_src_a_e_i));
        bufp->chgBit(oldp+69,(vlSelfRef.cpu_tb__DOT__dut__DOT__alu_src_b_e_i));
        bufp->chgCData(oldp+70,(vlSelfRef.cpu_tb__DOT__dut__DOT____Vcellout__de__funct3_e),3);
        bufp->chgCData(oldp+71,(vlSelfRef.cpu_tb__DOT__dut__DOT__rs1_e_i),5);
        bufp->chgCData(oldp+72,(vlSelfRef.cpu_tb__DOT__dut__DOT__rs2_e_i),5);
        bufp->chgIData(oldp+73,(vlSelfRef.cpu_tb__DOT__dut__DOT__alu_result_e_o),32);
        bufp->chgBit(oldp+74,(vlSelfRef.cpu_tb__DOT__dut__DOT__pc_src_e_o));
        bufp->chgIData(oldp+75,(vlSelfRef.cpu_tb__DOT__dut__DOT__alu_result_m_i),32);
        bufp->chgIData(oldp+76,(vlSelfRef.cpu_tb__DOT__dut__DOT__write_data_m_i),32);
        bufp->chgIData(oldp+77,(vlSelfRef.cpu_tb__DOT__dut__DOT__pc_plus4_m_i),32);
        bufp->chgBit(oldp+78,(vlSelfRef.cpu_tb__DOT__dut__DOT__mem_write_m_i));
        bufp->chgBit(oldp+79,(vlSelfRef.cpu_tb__DOT__dut__DOT__reg_write_m_i));
        bufp->chgCData(oldp+80,(vlSelfRef.cpu_tb__DOT__dut__DOT__res_src_m_i),2);
        bufp->chgCData(oldp+81,(vlSelfRef.cpu_tb__DOT__dut__DOT____Vcellout__em__funct3_m),3);
        bufp->chgCData(oldp+82,(vlSelfRef.cpu_tb__DOT__dut__DOT__rd_m_i),5);
        bufp->chgIData(oldp+83,(vlSelfRef.cpu_tb__DOT__dut__DOT__read_data_m_o),32);
        bufp->chgBit(oldp+84,(vlSelfRef.cpu_tb__DOT__dut__DOT__reg_write_w_i));
        bufp->chgCData(oldp+85,(vlSelfRef.cpu_tb__DOT__dut__DOT__result_src_w_i),2);
        bufp->chgIData(oldp+86,(vlSelfRef.cpu_tb__DOT__dut__DOT__read_data_w_i),32);
        bufp->chgCData(oldp+87,(vlSelfRef.cpu_tb__DOT__dut__DOT__rd_w_i),5);
        bufp->chgIData(oldp+88,(vlSelfRef.cpu_tb__DOT__dut__DOT__pc_plus4_w_i),32);
        bufp->chgIData(oldp+89,(vlSelfRef.cpu_tb__DOT__dut__DOT__alu_result_w_o),32);
        bufp->chgBit(oldp+90,(vlSelfRef.cpu_tb__DOT__dut__DOT__stall_f));
        bufp->chgBit(oldp+91,(((IData)(vlSelfRef.cpu_tb__DOT__dut__DOT__stall_f) 
                               | (IData)(vlSelfRef.cpu_tb__DOT__dut__DOT__pc_src_e_o))));
        bufp->chgCData(oldp+92,(vlSelfRef.cpu_tb__DOT__dut__DOT__forward_a_e),2);
        bufp->chgCData(oldp+93,(vlSelfRef.cpu_tb__DOT__dut__DOT__forward_b_e),2);
        bufp->chgCData(oldp+94,((7U & (IData)(vlSelfRef.cpu_tb__DOT__dut__DOT__decode_stage__DOT__cu__DOT__controls))),3);
        bufp->chgCData(oldp+95,((0x7fU & vlSelfRef.cpu_tb__DOT__dut__DOT__instr_d_i)),7);
        bufp->chgBit(oldp+96,((1U & (vlSelfRef.cpu_tb__DOT__dut__DOT__instr_d_i 
                                     >> 0x1eU))));
        bufp->chgSData(oldp+97,(vlSelfRef.cpu_tb__DOT__dut__DOT__decode_stage__DOT__cu__DOT__controls),11);
        bufp->chgIData(oldp+98,((vlSelfRef.cpu_tb__DOT__dut__DOT__instr_d_i 
                                 >> 7U)),25);
        bufp->chgIData(oldp+99,(vlSelfRef.cpu_tb__DOT__dut__DOT__execute_stage__DOT__a_alu),32);
        bufp->chgIData(oldp+100,(vlSelfRef.cpu_tb__DOT__dut__DOT__execute_stage__DOT__b_alu),32);
        bufp->chgIData(oldp+101,(((0U == (IData)(vlSelfRef.cpu_tb__DOT__dut__DOT__forward_a_e))
                                   ...
                                   : ((1U == (IData)(vlSelfRef.cpu_tb__DOT__dut__DOT__forward_a_e))
                                       ...
                                       : ((2U == (IData)(vlSelfRef.cpu_tb__DOT__dut__DOT__forward_a_e))
                                           ...
                                           : 0U)))),32);
        bufp->chgIData(oldp+102,(((0U == (IData)(vlSelfRef.cpu_tb__DOT__dut__DOT__forward_b_e))
                                   ...
                                   : ((1U == (IData)(vlSelfRef.cpu_tb__DOT__dut__DOT__forward_b_e))
                                       ...
                                       : ((2U == (IData)(vlSelfRef.cpu_tb__DOT__dut__DOT__forward_b_e))
                                           ? vlSelfRef.cpu_tb__DOT__dut__DOT__alu_result_w_o
                                           : 0U)))),32);
        bufp->chgBit(oldp+103,((1U & ((0U == (6U & (IData)(vlSelfRef.cpu_tb__DOT__dut__DOT____Vcellout__de__funct3_e)))
                                       ...
                                       : ((4U == (6U 
                                           ...
                                           : ((6U == 
                                              ...
                                              & ((IData)(vlSelfRef.cpu_tb__DOT__dut__DOT____Vcellout__de__funct3_e) 
                                                 ...
                                                 (vlSelfRef.cpu_tb__DOT__dut__DOT__rd1_e_i 
                                                  < vlSelfRef.cpu_tb__DOT__dut__DOT__rd2_e_i))))))));
        bufp->chgBit(oldp+104,((1U & (IData)(vlSelfRef.cpu_tb__DOT__dut__DOT__res_src_e_i))));
        bufp->chgIData(oldp+105,((0x3fU & (vlSelfRef.cpu_tb__DOT__dut__DOT__alu_result_m_i 
                                           >> 2U))),32);
    }
