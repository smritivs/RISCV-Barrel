...
VL_ATTR_COLD void Vmt_cpu_tb___024root__trace_init_sub__TOP__0(Vmt_cpu_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+97,0,"ADDRESS_WIDTH",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+98,0,"NUM_THREADS",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+99,0,"DMEM_SIZE",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+100,0,"IMEM_SIZE",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBit(c+92,0,"rst",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+101,0,"BITS_THREADS",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+94,0,"instr_f_o",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+81,0,"prev_read_tid",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 1,0);
    ...
    tracep->declBus(c+38,0,"tid_e",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 1,0);
    tracep->declBus(c+101,0,"BITS_THREADS",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+82,0,"a_alu",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+83,0,"b_alu",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBit(c+84,0,"branch_result",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+84,0,"branch_result",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->popPrefix();
    ...
    tracep->declBus(c+94,0,"instr_f",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+94,0,"instr_f",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+97,0,"ADDRESS_WIDTH",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+97,0,"DATA_WIDTH",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+100,0,"MEM_SIZE",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBus(c+94,0,"instr",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->popPrefix();
    ...
    tracep->declBus(c+42,0,"write_data_e",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+50,0,"read_data_m",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+90,0,"word_addr",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+91,0,"word",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
...
VL_ATTR_COLD void Vmt_cpu_tb___024root__trace_const_0_sub_0(Vmt_cpu_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+103,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__decode_stage__DOT__rf__DOT__curr_reg_write[0]),32);
    bufp->fullIData(oldp+104,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__decode_stage__DOT__rf__DOT__curr_reg_write[1]),32);
    bufp->fullIData(oldp+105,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__decode_stage__DOT__rf__DOT__curr_reg_write[2]),32);
    bufp->fullIData(oldp+106,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__decode_stage__DOT__rf__DOT__curr_reg_write[3]),32);
    bufp->fullIData(oldp+107,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__decode_stage__DOT__rf__DOT__curr_reg_write[4]),32);
    bufp->fullIData(oldp+108,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__decode_stage__DOT__rf__DOT__curr_reg_write[5]),32);
    bufp->fullIData(oldp+109,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__decode_stage__DOT__rf__DOT__curr_reg_write[6]),32);
    bufp->fullIData(oldp+110,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__decode_stage__DOT__rf__DOT__curr_reg_write[7]),32);
    bufp->fullIData(oldp+111,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__decode_stage__DOT__rf__DOT__curr_reg_write[8]),32);
    bufp->fullIData(oldp+112,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__decode_stage__DOT__rf__DOT__curr_reg_write[9]),32);
    bufp->fullIData(oldp+113,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__decode_stage__DOT__rf__DOT__curr_reg_write[10]),32);
    bufp->fullIData(oldp+114,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__decode_stage__DOT__rf__DOT__curr_reg_write[11]),32);
    bufp->fullIData(oldp+115,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__decode_stage__DOT__rf__DOT__curr_reg_write[12]),32);
    bufp->fullIData(oldp+116,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__decode_stage__DOT__rf__DOT__curr_reg_write[13]),32);
    bufp->fullIData(oldp+117,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__decode_stage__DOT__rf__DOT__curr_reg_write[14]),32);
    bufp->fullIData(oldp+118,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__decode_stage__DOT__rf__DOT__curr_reg_write[15]),32);
}
...
VL_ATTR_COLD void Vmt_cpu_tb___024root__trace_full_0_sub_0(Vmt_cpu_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+81,((3U & ((IData)(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__tid_d_i) 
                                    - (IData)(1U)))),2);
    bufp->fullIData(oldp+82,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__execute_stage__DOT__a_alu),32);
    bufp->fullIData(oldp+83,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__execute_stage__DOT__b_alu),32);
    bufp->fullBit(oldp+84,((1U & ((0U == (6U & (IData)(vlSelfRef.mt_cpu_tb__DOT__dut__DOT____Vcellout__de__funct3_e)))
                                   ? ((IData)(vlSelfRef.mt_cpu_tb__DOT__dut__DOT____Vcellout__de__funct3_e) 
                                      ^ (vlSelfRef.mt_cpu_tb__DOT__dut__DOT__rd1_e_i 
                                         == vlSelfRef.mt_cpu_tb__DOT__dut__DOT__rd2_e_i))
                                   : ((4U == (6U & (IData)(vlSelfRef.mt_cpu_tb__DOT__dut__DOT____Vcellout__de__funct3_e)))
                                       ...
                                       : ((6U == (6U 
                                          ...
                                          && (1U & 
                                              ((IData)(vlSelfRef.mt_cpu_tb__DOT__dut__DOT____Vcellout__de__funct3_e) 
                                               ^ (vlSelfRef.mt_cpu_tb__DOT__dut__DOT__rd1_e_i 
                                                  < vlSelfRef.mt_cpu_tb__DOT__dut__DOT__rd2_e_i)))))))));
    bufp->fullIData(oldp+85,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__fetch_stage__DOT__thread_pc__DOT__t_pc[0]),32);
    bufp->fullIData(oldp+86,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__fetch_stage__DOT__thread_pc__DOT__t_pc[1]),32);
    bufp->fullIData(oldp+87,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__fetch_stage__DOT__thread_pc__DOT__t_pc[2]),32);
    bufp->fullIData(oldp+88,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__fetch_stage__DOT__thread_pc__DOT__t_pc[3]),32);
    bufp->fullIData(oldp+89,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__fetch_stage__DOT__thread_pc__DOT__i),32);
    bufp->fullIData(oldp+90,((0x3fU & (vlSelfRef.mt_cpu_tb__DOT__dut__DOT__alu_result_m_i 
                                       >> 2U))),32);
    bufp->fullIData(oldp+91,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__memory_stage__DOT__dm__DOT__word),32);
    bufp->fullBit(oldp+92,(vlSelfRef.mt_cpu_tb__DOT__rst));
    bufp->fullBit(oldp+93,(vlSelfRef.mt_cpu_tb__DOT__clk));
    bufp->fullIData(oldp+94,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__fetch_stage__DOT__i_mem__DOT__instr_rom
                             [(0x3ffU & (vlSelfRef.mt_cpu_tb__DOT__dut__DOT__fetch_stage__DOT__thread_pc__DOT__t_pc
                                         ...
                                         >> 2U))]),32);
    bufp->fullIData(oldp+95,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__decode_stage__DOT__rf__DOT__i),32);
    bufp->fullIData(oldp+96,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__memory_stage__DOT__dm__DOT__i),32);
}
