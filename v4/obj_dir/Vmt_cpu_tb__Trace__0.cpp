...
void Vmt_cpu_tb___024root__trace_chg_0_sub_0(Vmt_cpu_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U]))) {
        ...
        bufp->chgIData(oldp+80,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__execute_stage__DOT__a_alu),32);
        bufp->chgIData(oldp+81,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__execute_stage__DOT__b_alu),32);
        bufp->chgBit(oldp+82,((1U & ((0U == (6U & (IData)(vlSelfRef.mt_cpu_tb__DOT__dut__DOT____Vcellout__de__funct3_e)))
                                      ? ((IData)(vlSelfRef.mt_cpu_tb__DOT__dut__DOT____Vcellout__de__funct3_e) 
                                         ^ (vlSelfRef.mt_cpu_tb__DOT__dut__DOT__rd1_e_i 
                                            == vlSelfRef.mt_cpu_tb__DOT__dut__DOT__rd2_e_i))
                                      : ((4U == (6U 
                                          ...
                                          : ((6U == 
                                             ...
                                             && (1U 
                                                 & ((IData)(vlSelfRef.mt_cpu_tb__DOT__dut__DOT____Vcellout__de__funct3_e) 
                                                    ...
                                                    (vlSelfRef.mt_cpu_tb__DOT__dut__DOT__rd1_e_i 
                                                     < vlSelfRef.mt_cpu_tb__DOT__dut__DOT__rd2_e_i)))))))));
        bufp->chgIData(oldp+83,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__fetch_stage__DOT__thread_pc__DOT__t_pc[0]),32);
        bufp->chgIData(oldp+84,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__fetch_stage__DOT__thread_pc__DOT__t_pc[1]),32);
        bufp->chgIData(oldp+85,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__fetch_stage__DOT__thread_pc__DOT__t_pc[2]),32);
        bufp->chgIData(oldp+86,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__fetch_stage__DOT__thread_pc__DOT__t_pc[3]),32);
        bufp->chgIData(oldp+87,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__fetch_stage__DOT__thread_pc__DOT__i),32);
        bufp->chgIData(oldp+88,((0x3fU & (vlSelfRef.mt_cpu_tb__DOT__dut__DOT__alu_result_m_i 
                                          >> 2U))),32);
        bufp->chgIData(oldp+89,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__memory_stage__DOT__dm__DOT__word),32);
    }
    bufp->chgBit(oldp+90,(vlSelfRef.mt_cpu_tb__DOT__rst));
    bufp->chgBit(oldp+91,(vlSelfRef.mt_cpu_tb__DOT__clk));
    bufp->chgIData(oldp+92,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__fetch_stage__DOT__i_mem__DOT__instr_rom
                            [(0x3ffU & (vlSelfRef.mt_cpu_tb__DOT__dut__DOT__fetch_stage__DOT__thread_pc__DOT__t_pc
                                        ...
                                        >> 2U))]),32);
    bufp->chgIData(oldp+93,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__decode_stage__DOT__rf__DOT__i),32);
    bufp->chgIData(oldp+94,(vlSelfRef.mt_cpu_tb__DOT__dut__DOT__memory_stage__DOT__dm__DOT__i),32);
}
